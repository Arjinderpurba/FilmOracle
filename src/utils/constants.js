...
export const LOGO = require("../assets/filmoracle-logo.png");
...
export const TMDB_MOVIE_DETAILS = (movieId) =>
  `https://api.themoviedb.org/3/movie/${movieId}?language=en-US`;

export const TMDB_MOVIE_VIDEOS = (movieId) =>
  `https://api.themoviedb.org/3/movie/${movieId}/videos?language=en-US`;

// CORS proxy function for Safari
export const getProxiedUrl = (url) => {
  ...
  if (isSafari) {
    ...
    const proxy = proxies[0]; // Try first proxy
